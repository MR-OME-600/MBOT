...
(async () => {
  const {
    data: _0x187dd6
  } = await axios.get("https://raw.githubusercontent.com/Priyansh-11/Priyansh-bot/main/versions.json");
  ...
  const {
    data: _0x24fa9e
  } = await axios.get('https://github.com/MR-OME-600/MBOT/blob/main/package.json');
